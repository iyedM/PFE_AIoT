...
CORS(app, resources={r"/*": {"origins": "http://127.0.0.1:3000"}})  # Allow requests from localhost:3000
...
def handle_disconnect():
    ...
    thread_running = False
#image_path="/home/pi/Desktop/wheat1.jpg"
@app.route('/data')
def get_data():
    #humidity, temperature = read_dht11_data()
...
@app.route('/quality')
def get_quality():
    result = predict_wheat_class("/home/pi/Desktop/test.jpg")
